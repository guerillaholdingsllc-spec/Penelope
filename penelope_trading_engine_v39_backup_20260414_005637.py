...
def main():
    ...
    post_feed("Engine v3.9 Online", f"Trading engine v3.9 started (TrailingStop+TakeProfit+MonteCarl+DailyLimit) (MinBuy$3k-$5k+QualityGate) (OptimizedThresholds) (PortfolioCap+VolAdj+Benchmark). {len(STRATEGIES)} strategies.", "success")
